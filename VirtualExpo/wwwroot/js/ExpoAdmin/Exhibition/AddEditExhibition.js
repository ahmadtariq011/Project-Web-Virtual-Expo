...
function SaveExhibition() {
    ...
    var User =
    {
        ...
        OraganizerName: $.trim($("#txtOrganizername").val()),
        StartDate: $.trim($("#txtStartDate").val()),
        EndDate: $.trim($("#txtEndDate").val()),
        Organizer_User_Id: $.trim($("#hfOrganizerid").val()),
        ExhibitionStatusStr: $.trim($("#txtStatus").val())
    };

    $.post("/api/ExhibitionApi/SaveExhibition", User, SaveExhibitionCallback);
}
